...
main() {
    ...
    if ! is_param 'inc' "$@"; then
        make -C u-boot distclean
        make -C u-boot radxa-e25-rk3568_defconfig
    fi
...
cherry_pick() {
    ...
    # https://github.com/u-boot/u-boot/commit/1f54f71b182e3515f72870a75ce2ba769b00b1f3
    git -C u-boot format-patch -1 1f54f71b182e3515f72870a75ce2ba769b00b1f3
    sed -i '868,879d' 'u-boot/0001-board-rockchip-Add-Radxa-E25-Carrier-Board.patch'
    git -C u-boot am '0001-board-rockchip-Add-Radxa-E25-Carrier-Board.patch'
    rm -f '0001-board-rockchip-Add-Radxa-E25-Carrier-Board.patch'
