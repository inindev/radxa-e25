...
package-%: all
	...
	@cp -v dtb/rk3568-radxa-e25.dtb distfiles
	@cp -v debian/mmc_2g.img distfiles/radxa-e25_$(LDIST)-$*.img
	@xz -zve8 distfiles/radxa-e25_$(LDIST)-$*.img
